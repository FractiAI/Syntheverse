...
RAG (Retrieval-Augmented Generation) pipeline for Syntheverse, using Groq (fast cloud LLM) as the primary provider, with Hugging Face and Ollama as fallbacks.
...
├── analysis/
│   └── [analysis tools]      # Analysis and visualization
└── api/
